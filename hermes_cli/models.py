...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("antigravity-cli", "Google Antigravity CLI (AI Pro)", "Google Antigravity CLI via official agy Headless protocol (AI Pro)"),
...
PROVIDER_GROUPS: dict[str, tuple[str, str, list[str]]] = {
    ...
    "google":   ("Google Gemini",   "AI Studio API, Gemini CLI OAuth, or Antigravity CLI (AI Pro)", ["gemini", "google-gemini-cli", "antigravity-cli"]),
